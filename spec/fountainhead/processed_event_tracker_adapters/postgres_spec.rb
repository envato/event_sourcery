RSpec.describe Fountainhead::ProcessedEventTrackerAdapters::Postgres do
  subject(:postgres_tracker) { described_class.new(connection) }
  let(:table_name) { Fountainhead::ProcessedEventTrackerAdapters::Postgres::TABLE_NAME }
  ...
  describe '#processed_event' do
    ...
    it "doesn't allow out of order processing" do
      ...
      }.to raise_error(Fountainhead::NonSequentialEventProcessingError)
    end
  end
