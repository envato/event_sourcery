RSpec.describe ESFramework::EventSourceAdapters::Postgres do
  let(:aggregate_id) { SecureRandom.uuid }
  let(:event_body) { { 'my_event' => 'data' } }
  let(:event_1) { ESFramework::Event.new(id: 1, type: 'my_event', aggregate_id: aggregate_id, body: event_body) }
  let(:event_2) { ESFramework::Event.new(id: 2, type: 'my_event', aggregate_id: aggregate_id, body: event_body) }
