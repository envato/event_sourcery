...
require 'event_sourcery/event_store/class_name_event_type_serializer'
require 'event_sourcery/event_store/generic_event_type_serializer'
...
require 'event_sourcery/event_processing/reactor'
