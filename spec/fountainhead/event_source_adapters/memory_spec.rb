RSpec.describe Fountainhead::EventSourceAdapters::Memory do
  let(:aggregate_id) { SecureRandom.uuid }
  let(:event_1) { Fountainhead::Event.new(id: 1, type: 'billing_details_provided', aggregate_id: aggregate_id, body: {}) }
  let(:event_2) { Fountainhead::Event.new(id: 2, type: 'billing_details_provided', aggregate_id: aggregate_id, body: {}) }
  let(:event_3) { Fountainhead::Event.new(id: 3, type: 'billing_details_provided', aggregate_id: SecureRandom.uuid, body: {}) }
