  ...
  module EventProcessing
    ...
    class EventDispatcher
      ...
      def track_and_send_to_processor(event_processor, events)
        ...
        if process_in_batches?(event_processor)
          process_batch(event_processor, events, last_processed_event_id, last_event_id)
        else
      ...
      def process_in_batches?(event_processor)
        event_processor.class.batch_processing_enabled?
      end

      def process_batch(event_processor, events, last_processed_event_id, last_event_id)
