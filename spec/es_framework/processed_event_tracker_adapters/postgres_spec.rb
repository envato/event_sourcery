RSpec.describe ESFramework::ProcessedEventTrackerAdapters::Postgres do
  subject(:postgres_tracker) { described_class.new(connection) }
  let(:table_name) { ESFramework::ProcessedEventTrackerAdapters::Postgres::TABLE_NAME }
  ...
  describe '#processed_event' do
    ...
    it "doesn't allow out of order processing" do
      ...
      }.to raise_error(ESFramework::NonSequentialEventProcessingError)
    end
  end
