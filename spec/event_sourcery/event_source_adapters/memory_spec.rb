RSpec.describe EventSourcery::EventSourceAdapters::Memory do
  ...
  let(:event_1) { EventSourcery::Event.new(id: 1, type: 'billing_details_provided', aggregate_id: aggregate_id, body: {}) }
  let(:event_2) { EventSourcery::Event.new(id: 2, type: 'billing_details_provided', aggregate_id: aggregate_id, body: {}) }
  let(:event_3) { EventSourcery::Event.new(id: 3, type: 'billing_details_provided', aggregate_id: SecureRandom.uuid, body: {}) }
