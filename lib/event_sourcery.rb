...
require 'event_sourcery/event_subscriber'
require 'event_sourcery/event_publisher_adapters/postgres_push'
require 'event_sourcery/event_publisher_adapters/postgres_push/new_event_subscriber'
